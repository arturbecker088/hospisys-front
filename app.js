...
async function carregarFilaDoBanco() {
    try {
        ...
        filaPacientesSimulada = fila.map(item => ({
            ...
            protocolo: item.classificacao,
            sintomas: [],
            comorbidades: [],
            justificativas: [],
            hora: new Date(item.data_entrada).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' }),
